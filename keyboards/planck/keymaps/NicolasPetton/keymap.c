 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | GUI  | Adju | FN   | ARR  | LCTL | LALT | ENT  |SPCNUM| RALT | Mute | Vol- |Vol+  |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_LGUI, MO(_ADJUST), MO(_FN), MO(_ARROW), KC_LCTL, KC_LALT, KC_ENT, LT(_NUM,KC_SPC), KC_RALT, KC_MUTE, KC_VOLD, KC_VOLU
),
